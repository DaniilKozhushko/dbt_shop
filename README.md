...
32. Рефакторинг инициализации БД (+unlogged)
33. Заполнение таблиц сгенерированными данными
34. Создание seed products.csv
35. Обновление конфигурации seeds
36. Рефакторинг view 
37. Удаление products.csv и перенос таблицы в postgres
38. Рефакторинг БД 2.0
39. Удаление seeds
40. Добавление моделей таблиц в staging
41. Обновление конфигурации docker и добавление индексов в БД
42. Добавление новых packages
43. Удаление seeds и перенос данных из них в БД
44. Написание теста
45. Создание витрин
